...
export const EventContent: React.FC<EventContentProps> = ({ details, onRefine, isRefining, onNavigate }) => {
  ...
  return (
    ...
    <div className="relative -mt-16 bg-white rounded-t-[2rem] px-8 pt-10 pb-16 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] min-h-screen">
      ...
      {/* Intro Section */}
      <div className="mb-8">
        <h2 className="text-2xl font-sans font-bold text-slate-900 tracking-widest">{details.introTitle}</h2>
        ...
        <div className="space-y-4 mb-6">
          {details.introText.split('\n\n').map((paragraph, index) => {
            ...
            return (
              <p key={index} className="text-slate-600 leading-[1.8] text-justify text-[16px] font-sans tracking-wide mb-6">
                {paragraph}
              </p>
            );
          })}
